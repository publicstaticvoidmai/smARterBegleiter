...
public class QuizTFUI : MonoBehaviour
{

    [SerializeField] private QuizTFManager quizManager;
    [SerializeField] private Text questionText;
    [SerializeField] private List<Button> options;
    [SerializeField] private Color correct, wrong, normal;


    private QuizTFManager.Question question;
    ...
    public void SetQuestion(QuizTFManager.Question question)
    {
